plugins {
    ...
    alias(libs.plugins.kotlin.compose) // Pastikan alias ini ada di libs.versions.toml dan didefinisikan di Project build
    id("kotlin-parcelize")
...
dependencies {
    ...
    // implementation(libs.androidx.foundation) <-- BARIS INI DIHAPUS karena tidak terdefinisi
    ...
    // Accompanist Pager (Anda harus berhati-hati dengan versi lama ini)
